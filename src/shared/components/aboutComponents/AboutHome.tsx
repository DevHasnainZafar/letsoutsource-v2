  ...
  return (
    <div className="relative w-full h-[90vh] md:h-[750px] overflow-hidden flex flex-col">
      ...
      <div className="flex flex-col justify-center items-center flex-1 text-center text-white px-4">
        <h1
          className={`font-sora font-semibold text-[36px] md:text-[42px] leading-[46px] md:leading-[56px] tracking-[-1.28px] mb-6 transition-all duration-1000 ease-out ${
        ...
        <p
          className={`max-w-[660px] text-[#FFFFFFA8] text-[16px] leading-[28px] font-normal transition-all duration-1000 ease-out delay-200 ${
            animate ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
          }`}
        >
